...
```text
总计 904 · 已完成 570 · 未实现(骨架) 27 · 未导入 307
卡包      总数  已完成  未实现  未导入
10000        56      56       0       0
10001       142     142       0       0
10002        77      77       0       0
...
10009        76       0       0      76
90000        93      91       2       0
未完成卡按文本复杂度：中(41–100字) 249 · 短(≤40字) 128 · 长(>100字) 20 · 白板 1
```
...
| S-70 | 从两种指定卡中随机召唤 | 10564120 雾卷花·茎白的纹章（"召唤随机1个『纯洁白狐』或『神圣猎鹰』"） | `summon N card X` 是固定卡牌；随机选择的是已有实例，不能用来在两种卡牌定义间抽选。 |
