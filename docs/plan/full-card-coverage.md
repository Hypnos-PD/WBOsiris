...
```text
总计 904 · 已完成 847 · 未实现(骨架) 57 · 未导入 0
卡包      总数  已完成  未实现  未导入
10000        56      56       0       0
10001       142     142       0       0
10002        77      77       0       0
...
| S-87 | "上一回合中攻击过主战者"的跨回合攻击历史 | 10942110 绝倒的袭击者、10943110 尘土的不法者 | `own\|oppo.attacked_this_turn` 只看本回合；"自己的随从在自己的上一回合中攻击过主战者"需要把攻击历史保留一回合（或记录"上次我方回合是否攻击过主战者"）。 |
