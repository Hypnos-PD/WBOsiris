...
var (
	...
	abilities = set("ward", "storm", "rush", "bane", "drain", "intimidate", "barrier", "stealth", "aura", "ignore_ward", "ability_target_guard", "ability_destruction_guard", "damage_taken_up", "damage_to_zero", "cannot_attack", "cannot_attack_follower", "cannot_attack_leader")
...
// instanceFields 与 internal/engine/runner 的字段求值保持一致。
