...
func TestCompileDeterministicAndStructured(t *testing.T) {
	...
	if len(typed.Cards) != 452 || len(typed.Sources) != 452 {
...
func TestCompileTestPackStructured(t *testing.T) {
	...
	if len(typed.Scenarios) != 579 || typed.Scenarios[0].Name != "Orchis grants Storm and Bane to the summoned Lloyd" {
