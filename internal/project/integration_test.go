...
func TestCompileDeterministicAndStructured(t *testing.T) {
	...
	if len(typed.Cards) != 379 || len(typed.Sources) != 379 {
...
func TestCompileTestPackStructured(t *testing.T) {
	...
	if len(typed.Scenarios) != 472 || typed.Scenarios[0].Name != "Orchis grants Storm and Bane to the summoned Lloyd" {
