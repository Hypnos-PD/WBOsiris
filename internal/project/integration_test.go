...
func TestCompileDeterministicAndStructured(t *testing.T) {
	...
	if len(typed.Cards) != 235 || len(typed.Sources) != 235 {
...
func TestCompileTestPackStructured(t *testing.T) {
	...
	if len(typed.Scenarios) != 171 || typed.Scenarios[0].Name != "Orchis grants Storm and Bane to the summoned Lloyd" {
