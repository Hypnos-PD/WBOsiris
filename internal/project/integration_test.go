...
func TestCompileDeterministicAndStructured(t *testing.T) {
	...
	if len(typed.Cards) != 239 || len(typed.Sources) != 239 {
...
func TestCompileTestPackStructured(t *testing.T) {
	...
	if len(typed.Scenarios) != 226 || typed.Scenarios[0].Name != "Orchis grants Storm and Bane to the summoned Lloyd" {
