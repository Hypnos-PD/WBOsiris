...
func TestCompileDeterministicAndStructured(t *testing.T) {
	...
	if len(typed.Cards) != 253 || len(typed.Sources) != 253 {
...
func TestCompileTestPackStructured(t *testing.T) {
	...
	if len(typed.Scenarios) != 354 || typed.Scenarios[0].Name != "Orchis grants Storm and Bane to the summoned Lloyd" {
