...
func TestCompileDeterministicAndStructured(t *testing.T) {
	...
	if len(typed.Cards) != 240 || len(typed.Sources) != 240 {
...
func TestCompileTestPackStructured(t *testing.T) {
	...
	if len(typed.Scenarios) != 234 || typed.Scenarios[0].Name != "Orchis grants Storm and Bane to the summoned Lloyd" {
