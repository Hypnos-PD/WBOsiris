...
func TestCompileDeterministicAndStructured(t *testing.T) {
	...
	if len(typed.Cards) != 603 || len(typed.Sources) != 603 {
...
func TestCompileTestPackStructured(t *testing.T) {
	...
	if len(typed.Scenarios) != 804 || typed.Scenarios[0].Name != "Orchis grants Storm and Bane to the summoned Lloyd" {
