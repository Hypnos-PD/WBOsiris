...
func TestCompileDeterministicAndStructured(t *testing.T) {
	...
	if len(typed.Cards) != 527 || len(typed.Sources) != 527 {
...
func TestCompileTestPackStructured(t *testing.T) {
	...
	if len(typed.Scenarios) != 736 || typed.Scenarios[0].Name != "Orchis grants Storm and Bane to the summoned Lloyd" {
