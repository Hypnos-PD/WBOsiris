...
func TestCompileDeterministicAndStructured(t *testing.T) {
	...
	if len(typed.Cards) != 243 || len(typed.Sources) != 243 {
...
func TestCompileTestPackStructured(t *testing.T) {
	...
	if len(typed.Scenarios) != 260 || typed.Scenarios[0].Name != "Orchis grants Storm and Bane to the summoned Lloyd" {
