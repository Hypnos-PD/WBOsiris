...
func TestCompileDeterministicAndStructured(t *testing.T) {
	...
	if len(typed.Cards) != 250 || len(typed.Sources) != 250 {
...
func TestCompileTestPackStructured(t *testing.T) {
	...
	if len(typed.Scenarios) != 336 || typed.Scenarios[0].Name != "Orchis grants Storm and Bane to the summoned Lloyd" {
